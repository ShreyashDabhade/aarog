...
app = FastAPI(title="Privacy-First Medical RAG API")
...
class EncryptedPayload(BaseModel):
    ...
    filename: str
    # BUG FIX: Made optional because frontend v1 doesn't generate patient keys yet.
...
async def query_agent(q: str):
    ...
    try:
        ...
        # Return a polite error to the UI instead of crashing
